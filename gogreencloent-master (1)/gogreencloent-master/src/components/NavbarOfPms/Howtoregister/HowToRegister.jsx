  ...
  return (
    <>
      <div className="container mt-3 p-2">
        <div className="row">
          <h3 className="title mb-3 p-3" style={{ color: " #22c514" }}>
            You need just 3 things to become a Go Green Seller
          </h3>
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <h5
                      class="card-title"
                      style={{ fontSize: "16px", color: " #22c514" }}
                    >
                      At least 1 product to sell
                    </h5>
                    <small class="card-text text-center">
                      All you need is a minimum of 1 unique product to start
                      sellingon Go Green.
                    </small>
                  </div>
                </div>
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <small class="card-text text-center">
                      You are required to furnish the details of your GSTIN to
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <small class="card-text text-center">
                      A copy of the cancelled cheque of your bank account is
                      mandatory of registering.
                    </small>
                  </div>
                </div>
              </div>
