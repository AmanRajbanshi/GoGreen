        ...
        <div className="row">
          ...
          <div className="col mt-2" >
            <div className="card-body">
              ...
              <p className="card-text text-center fw-bold fs-15"  style={{color:" #23c814"}}>
          ...
          <div className="col mt-2" >
            <div className="card-body">
              ...
              <p className="card-text text-center fw-bold fs-15"  style={{color:" #23c814"}}>Get Orders Across Nepal.</p>
              <p style={{ textAlign: "left" }}>
...
gahat  kurda
          ...
          <div className="col mt-2">
            <div className="card-body">
              ...
              <p className="card-text text-center fw-bold fs-15"  style={{color:" #23c814"}}>Ship with ease</p>
              <p style={{ textAlign: "left" }}>
          ...
          <div className="col mt-2">
            <div className="card-body">
              ...
              <p className="card-text text-center fw-bold fs-15" style={{color:" #23c814"}}>Earn big</p>
              <p style={{ textAlign: "left" }}>
